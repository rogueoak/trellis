...
**Tailwind CSS** (v4), and the **`@rogueoak/canopy`** design system.
...
| File | Role |
|---|---|
| `package.json` | Dependencies (Next 16, React, `@rogueoak/canopy`, Tailwind v4) and scripts. |
...
| `app/globals.css` | Tailwind v4 entry (`@import "tailwindcss"`) plus the canopy styles. |
